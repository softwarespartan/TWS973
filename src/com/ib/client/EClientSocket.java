...
public class EClientSocket extends EClient implements EClientMsgSink  {
    ...
    public EReader  m_reader;
	private boolean shouldManageReader = false;

//	private Thread  messageProcessingThread = new Thread( () -> {
//		while(this.isConnected()){
//			m_signal.waitForSignal();
//			try {
//				if (this.isConnected()) m_reader.processMsgs();
//			} catch (IOException e) {
